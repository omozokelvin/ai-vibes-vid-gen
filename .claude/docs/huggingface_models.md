...
> **⚠️ DEPRECATED / HISTORICAL** — Hugging Face image generation is no longer used. Scene images are now generated locally via ComfyUI. See [local_image_generation.md](local_image_generation.md). This doc is kept for reference only.
